...
> Optimized for Ubuntu Desktop (XFCE + noVNC + Xvfb) inside Google Colab.
...
- **Minimal Notebook Bootstrap**: Clean 3-cell Colab notebook (`bootstrap/colab_bootstrap.ipynb`) that initializes XFCE/noVNC and launches the workstation app.
...
1. Open `bootstrap/colab_bootstrap.ipynb` in Google Colab.
